...
/**
  ...
  * The respective fractions of positive numbers, negative numbers and zeroes are 3/6 = 0.500000,  and 2/6 = 0.333333, 1/6=0.166667 respectively.
  */
object PlusMinus {
  ...
  def main(args: Array[String]) {
    ...
    for ( i <- 0 until n) {
      val z = sc.nextInt
      (if (z == 0) zeros += 1 else if (z > 0) positives += 1 else negatives += 1)
    }

    println(f"${positives/n}%1.6f%n${negatives/n}%1.6f%n${zeros/n}%1.6f%n")
  }
}
